...
public class ServiceProviderSignUp extends BaseTest{
    ...
    public Object[][] getDataFromDataProvider() {
        return new Object [][] {
                {"", "zakuanov", "test pro", "8183453434", "azat@testpro.io", "Password"},
                {"azat", "", "test pro", "8183453434", "azat@testpro.io", "Password"},
                {"azat", "zakuanov", "", "8183453434", "azat@testpro.io", "Password"},
                {"azat", "zakuanov", "test pro", "", "azat@testpro.io", "Password"},
                {"azat", "zakuanov", "test pro", "8183453434", "", "Password"},
                {"azat", "zakuanov", "test pro", "8183453434", "azat+test@testpro.io", "Password@2"}
        };
    }
    ...
    public void ServiceProviderRegistrationTest (String firstName, String lastName, String BN, String PH, String email, String password) throws InterruptedException {
